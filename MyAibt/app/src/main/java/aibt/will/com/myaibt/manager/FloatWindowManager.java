package aibt.will.com.myaibt.manager;
...
public class FloatWindowManager {
    ...
    public boolean createFloatWindow(final Context context, View view, int layoutParamWidth, int layoutParamHeight, boolean isfocus) {
        ...
        if (isfocus) {
            if (layoutParamHeight == LayoutParams.MATCH_PARENT) {
                ...
                mFloatWindowParams.flags = LayoutParams.FLAG_ALT_FOCUSABLE_IM;
            }
